...
public class ClueApplication {
    ...
    public LuceneContext newContext(
            String dir, ClueAppConfiguration config, boolean interactiveMode) throws Exception {
    ...
    public static void handleCommand(
            ClueContext ctx, String cmdName, String[] args, PrintStream out) {
