...
public class DocValCommand extends ClueCommand {
                ...
                case SORTED:
                    {
                        ...
                        if (sv.advanceExact(subid)) {
                            // TODO: Use a better approach for getting the binary value. See
                            // https://issues.apache.org/jira/browse/LUCENE-9796
    ...
    private Object readDocValues(String field, DocValuesType docValType, LeafReader atomicReader)
            throws IOException {
        Object docVals = null;
    ...
    private void showDocId(
        ...
        showDocId(
                docid,
                docBase,
                readDocValues(field, docValType, atomicReader),
                docValType,
                bref,
                out,
                segmentid);
